# Perfect Concealment - 100
Problem:
They gave a text file [stg100.txt](kapifiles/stg100.txt)
...
In the text you will notice there are some word that consists of suspicious various size of charactors
```
deFend
pandAs 
stronGest 
...
Let try to extract all suspicous word with Regex Tester for windows and then got the flag.
```
Regex: (\w+)([A-Z])
```
![solve.png](kapifiles/solve.png)
